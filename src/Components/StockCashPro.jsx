...
const StockCashPro = () => {
  return (
    <div className='container mx-auto mt-5 p-4'>
      <h1 className='text-3xl font-bold text-center mb-4'>Stock Cash Pro</h1>
      ...
      <div className='grid md:grid-cols-2 gap-6 mt-5'>
        <div className='border rounded-lg p-6 shadow-md hover:shadow-lg p-4 transition duration-300 text-center'>
          ...
          <p className='text-gray-500 mb-4'>
            Get 3-4 weekly stock calls with expert guidance. Perfect for active traders.
          </p>
          <a href="/contact">
